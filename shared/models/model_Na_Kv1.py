...
__all__ = ['model_Na_Kv1', 'model_Na_Kv1_decaying_current']
...
def model_Na_Kv1_decaying_current(params, resting_vm=-75. * mV, Na_start=5. * um, Na_end=35. * um,
                 gL_soma=1. / (15000. * ohm * cm ** 2),
                 gna_density=4000. * (siemens / meter ** 2), gk_density=1500. * (siemens / meter ** 2), morpho=None,
                 tau_decay=20*ms):
    '''
    ...
    dI/dt = -I/tau_decay : amp (point current)
    I_CC : amp (point current) 
    '''
    ...
    neuron = SpatialNeuron(morphology=morpho, model=eqs, Cm=Cm, Ri=Ri,
                           namespace=dict(EL=EL, ENa=ENa, EK=EK,
                                          ...
                                          Kn=Kn, Vn=Vn, Taun_max=Taun_max,
                                          Va_soma=Va_soma,
                                          Vh_soma=Vh_soma, tau_decay=tau_decay),
                           method="exponential_euler")
