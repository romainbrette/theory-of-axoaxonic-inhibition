...
In addition, there is a spatially distributed synaptic conductance (specified as conductance density).
'''
from brian2 import *

__all__ = ['model_Na_Kv1_extended_GABA']


def model_Na_Kv1_extended_GABA(params, resting_vm=75. * mV, Na_start=5. * um, Na_end=35. * um,
    ...
    # Equations
    eqs = '''
    Im = (gL*(EL-v) + gNa*m*h*(ENa-v) + gK*n**8*(EK-v) + gGABA*(EGABA-v)) : amp/meter**2
